...
• Presentation` , submissionDate: "Event Day"},
      { title: "DigiBattles", description: "Class 9-12", mode: "Online", classGroup: "Class 9-12", software: "Battlegrounds Mobile India (BGMI)", icon: Gamepad2, size: "col-span-1", featured: true, about: "DigiBattles brings teamwork and strategy into the spotlight. Students compete in teams through gaming challenges, testing coordination, communication, and quick decision-making. It’s not just about playing—it’s about strategy, collaboration, and performing under pressure.", venue: "Second Floor Classrooms", image: "/digi-battles.png", eventHead: "Divyansh Rathore", eventHeadNumber: "9560802211" , teamSize: "Team of 4", themes: ["The Ultimate Battlegrounds Mobile Tournament"], objectives: ["Step into the battleground and compete in DIGIBattle. Form your squad, showcase your teamwork, strategy, and gaming skills, and battle through intense TPP/FPP survival shooter matches against the best teams. Fight for victory, earn bragging rights, and experience the thrill of competitive mobile esports."], requirements: `<b>Requirements</b>
