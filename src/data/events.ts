...
export const categories: Category[] = [
  {
    ...
    events: [
      ...
      { 
        ...
        eventHead: "Rudransh Kandpal", eventHeadNumber: "+91 9910663253",
        teamSize: "Individual",
