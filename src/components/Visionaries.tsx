...
const fullSpeakers: Speaker[] = [
  ...
  { name: "Prajanay Chandra", role: "Video Director", company: "Digit Crew", initial: "PC", image: "/Prajanay Chandra.jpg", bio: "The mastermind behind execution, he seamlessly orchestrates event workflows and ensures every project hits its creative mark perfectly." },
  ...
  { name: "Sheza Khan", role: "Content Director", company: "Digit Crew", initial: "SK", image: "/Sheza Khan.jpg", bio: "The guardian of information, she meticulously manages critical backend data, ensuring seamless organization and high operational efficiency." },
